...
public class WithdrawResourceImpl extends WithdrawResourceDecorator {
    ...
    public Withdraw createWithdraw(VMJExchange vmjExchange){
		...
		if (disbursementMethod.equals("Money Transfer")) {
		...
		else if (disbursementMethod.equals("Agent Money Transfer")) {
	        HttpClient client = HttpClient.newHttpClient();
	        ...
	        try {
	            ...
	            Map<String, Object> rawResponseMap = gson.fromJson(responseBody, mapType);
	            Map<String, Object> dataMap = (Map<String, Object>) rawResponseMap.get("data");
	            int agentMoneyTransferIdInt = ((Double) dataMap.get("id")).intValue();
	            agentMoneyTransferDirection = (String) dataMap.get("direction");

	            int disbursementIdInt = ((Double) dataMap.get("id")).intValue();
	            agentMoneyTransferId = String.valueOf(agentMoneyTransferIdInt);
	            disbursementId = String.valueOf(disbursementIdInt);
	        } catch (Exception e) {
	            System.err.println("Error: " + e.getMessage());
	        }
		...
		else if (disbursementMethod.equals("International Money Transfer")) {
	        HttpClient client = HttpClient.newHttpClient();
	        ...
	        try {
	            ...
	            Map<String, Object> rawResponseMap = gson.fromJson(responseBody, mapType);
	            Map<String, Object> dataMap = (Map<String, Object>) rawResponseMap.get("data");
	            int internationalMoneyTransferExchangeRateInt = ((Double) dataMap.get("exchange_rate")).intValue();
	            int internationalMoneyTransferFeeInt = ((Double) dataMap.get("fee")).intValue();
				...
				int internationalMoneyTransferAmountInSenderCountryInt = ((Double) dataMap.get("amount_in_sender_country")).intValue();
				internationalMoneyTransferBeneficiaryCurrencyCode = (String) dataMap.get("beneficiary_currency_code");

	            int disbursementIdInt = ((Double) dataMap.get("id")).intValue();
	            disbursementId = String.valueOf(disbursementIdInt);
	            internationalMoneyTransferExchangeRate = String.valueOf(internationalMoneyTransferExchangeRateInt);
	            internationalMoneyTransferFee = String.valueOf(internationalMoneyTransferFeeInt);
	            internationalMoneyTransferAmountInSenderCountry = String.valueOf(internationalMoneyTransferAmountInSenderCountryInt);
		...
		else if (disbursementMethod.equals("Special Money Transfer")) {
	        HttpClient client = HttpClient.newHttpClient();
...
//			    }
	            ...
	            int disbursementIdInt = ((Double) dataMap.get("id")).intValue();
	            disbursementId = String.valueOf(disbursementIdInt);
	            specialMoneyTransferSenderCountry = String.valueOf(specialMoneyTransferSenderCountryInt);
	        } catch (Exception e) {
	            System.err.println("Error: " + e.getMessage());
	        }
		}
