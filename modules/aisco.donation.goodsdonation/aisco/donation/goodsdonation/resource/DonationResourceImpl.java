...
public class DonationResourceImpl extends DonationResourceDecorator {
    ...
    public HashMap<String,Object> saveGoodsDonation(VMJExchange vmjExchange){
    	List<String> keys = new ArrayList<String>(Arrays.asList("proofofdonation", "name", "email", "phone",
                "description", "idprogram", "quantity"));
    ...
    public Donation createDonation(VMJExchange vmjExchange, UUID id) {
        ...
        Donation goodsDonation = DonationFactory.createDonation("aisco.donation.goodsdonation.DonationImpl", id, donation, quantity, 
    ...
    public List<HashMap<String,Object>> getAllDonation(VMJExchange vmjExchange){
        ...
        if (checkRole(userRoles, "Registered")) {
